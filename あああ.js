...
var init = () => {
    ...
    // c2
    {
        ...
        c2 = theory.createUpgrade(1, currency, new ExponentialCost(1, Math.log2(3)));
...
var getPublicationMultiplier = (tau) => tau.pow(0.668) / BigNumber.THREE;
var getPublicationMultiplierFormula = (symbol) => "\\frac{{" + symbol + "}^{0.668}}{3}";
var getTau = () => currency.value;
var get2DGraphValue = () => currency.value.sign * (BigNumber.ONE + currency.value.abs()).log10().toNumber();

var getC1 = (level) => Utils.getStepwisePowerSum(level, 2, 10, 0);
var getC2 = (level) => BigNumber.TWO.pow(level);
var getC1Exponent = (level) => BigNumber.from(1 + 1 * level);
var getC2Exponent = (level) => BigNumber.from(1 + 2 * level);
